...
export default function PhotoLibrarySnippets() {
  ...
  useEffect(() => {
    callApi('files/Snippets', 'get', null).then(res => {
      setData(res.data)
    });
  });
      ...
      for (var i = 0; i < selectedFile.length; i++) {
        ...
        try {
          const response = await axios({
            method: "post",
            url: "http://localhost:8080/files/uploadSnippets",
            data: formData,
  ...
  const handleDeleteImage = (e) => {
    callApi(`files/Snippet/${e}`, 'delete', null)
  }
