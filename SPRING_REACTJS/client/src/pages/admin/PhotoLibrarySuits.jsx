...
export default function PhotoLibrarySuits() {
  ...
  useEffect(() => {
    callApi('files/Suits', 'get', null).then(res => {
      setData(res.data)
    });
  });
      ...
      for (var i = 0; i < selectedFile.length; i++) {
        ...
        try {
          const response = await axios({
            method: "post",
            url: "http://localhost:8080/files/uploadSuits",
            data: formData,
  ...
  const handleDeleteImage = (e) => {
    callApi(`files/Suit/${e}`, 'delete', null)
  }
