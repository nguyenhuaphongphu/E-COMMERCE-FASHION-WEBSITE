...
export default function PhotoLibraryShirts() {
  ...
  useEffect(() => {
    callApi('files/Shirts', 'get', null).then(res => {
      setData(res.data)
    });
  });
      ...
      for (var i = 0; i < selectedFile.length; i++) {
        ...
        try {
          const response = await axios({
            method: "post",
            url: "http://localhost:8080/files/uploadShirts",
            data: formData,
  ...
  const handleDeleteImage = (e) => {
    callApi(`files/Shirt/${e}`, 'delete', null)
  }
