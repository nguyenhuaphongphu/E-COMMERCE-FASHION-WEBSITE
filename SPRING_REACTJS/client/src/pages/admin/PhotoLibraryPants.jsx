...
export default function PhotoLibraryPants() {
  ...
  useEffect(() => {
    callApi('files/Pants', 'get', null).then(res => {
      setData(res.data)
    });
  });
      ...
      for (var i = 0; i < selectedFile.length; i++) {
        ...
        try {
          const response = await axios({
            method: "post",
            url: "http://localhost:8080/files/uploadPants",
            data: formData,
  ...
  const handleDeleteImage = (e) => {
    callApi(`files/Pants/${e}`, 'delete', null)
  }
